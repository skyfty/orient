...
#ifndef ORIENT_COLLISION_MONITOR__TYPES_HPP_
#define ORIENT_COLLISION_MONITOR__TYPES_HPP_
...
struct Velocity
{
  ...
  double angular_x;  // z-component of angular twist
  ...
  {
    return {x * mul, y * mul, tw * mul,angular_x};
  }


  inline Velocity mul(const double & v, bool ev = true) const
  {
    return ev ? Velocity{x * v, y * v, tw * v, angular_x} : Velocity{x * v, y * v, tw, angular_x};
  }
...
#endif  // ORIENT_COLLISION_MONITOR__TYPES_HPP_
