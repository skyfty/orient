...
#include "orient_velocity_smoother/velocity_smoother.hpp"
...
namespace orient_velocity_smoother
{
...
void VelocitySmoother::smootherTimer()
{
  ...
  cmd_vel->angular.x = command_->angular.x;
  cmd_vel->angular.y = command_->angular.y;
  last_cmd_ = *cmd_vel;
...
RCLCPP_COMPONENTS_REGISTER_NODE(orient_velocity_smoother::VelocitySmoother)
