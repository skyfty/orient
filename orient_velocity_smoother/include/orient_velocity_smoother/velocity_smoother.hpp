...
/**
 * @class orient_velocity_smoother::VelocitySmoother
...
public:
  /**
   * @brief A constructor for orient_velocity_smoother::VelocitySmoother
   * @param options Additional options to control creation of the node.
   */
  explicit VelocitySmoother(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());

  /**
   * @brief Destructor for orient_velocity_smoother::VelocitySmoother
   */
  ~VelocitySmoother();
