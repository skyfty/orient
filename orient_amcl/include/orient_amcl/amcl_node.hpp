...
#include "orient_amcl/motion_model/motion_model.hpp"
...
protected:
  ...
  nav_msgs::msg::Odometry::SharedPtr odom_pose_;
   ...
   */
  void initOdometry();
  std::shared_ptr<orient_amcl::MotionModel> motion_model_;
  ...
  double init_cov_[3];
  pluginlib::ClassLoader<orient_amcl::MotionModel> plugin_loader_{"orient_amcl",
    "orient_amcl::MotionModel"};
  /*
   ...
   */
  orient_amcl::Laser * createLaserObject();
  int scan_error_count_{0};
  std::vector<orient_amcl::Laser *> lasers_;
