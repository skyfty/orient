...
#ifndef ORIENT_CONTROLLER__CONTROLLER_SERVER_HPP_
#define ORIENT_CONTROLLER__CONTROLLER_SERVER_HPP_
...
/**
 * @class orient_controller::ControllerServer
...
public:
  ...
  /**
   * @brief Constructor for orient_controller::ControllerServer
   * @param options Additional options to control creation of the node.
   */
  explicit ControllerServer(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());
  /**
   * @brief Destructor for orient_controller::ControllerServer
   */
  ~ControllerServer();
...
#endif  // ORIENT_CONTROLLER__CONTROLLER_SERVER_HPP_