...
#ifndef ORIENT_ROTATION_SHIM_CONTROLLER__ORIENT_ROTATION_SHIM_CONTROLLER_HPP_
#define ORIENT_ROTATION_SHIM_CONTROLLER__ORIENT_ROTATION_SHIM_CONTROLLER_HPP_
...
protected:
   ...
   */
  geometry_msgs::msg::Pose transformPoseToBaseFrame(const geometry_msgs::msg::PoseStamped & pose,const geometry_msgs::msg::PoseStamped & pt);
  ...
  // geometry_msgs::msg::TransformStamped odom_to_map_transform_;
  ...
  std::mutex mutex_;
  std::unique_ptr<orient_controller::PositionGoalChecker> position_goal_checker_;
};
}
#endif