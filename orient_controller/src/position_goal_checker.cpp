...
void orient_controller::PositionGoalChecker::setXYGoalTolerance(double tolerance)
{
...
PLUGINLIB_EXPORT_CLASS(orient_controller::PositionGoalChecker, nav2_core::GoalChecker)
