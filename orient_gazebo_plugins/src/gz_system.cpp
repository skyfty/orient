...
struct jointData
{
  ...
  orient_gazebo_plugins::GazeboSimSystemInterface::ControlMethod joint_control_method;
};
...
class orient_gazebo_plugins::GazeboSimSystemPrivate
{
public:
...
GazeboSimSystem::on_init(const hardware_interface::HardwareInfo & system_info)
{
  ...
  if (system_info.hardware_class_type.compare("orient_gazebo_plugins/GazeboSimSystem") != 0) {
    RCLCPP_WARN(
      this->nh_->get_logger(),
      "The orient_gazebo_plugins plugin got renamed to orient_gazebo_plugins.\n"
      "Update the <ros2_control> tag and gazebo plugin to\n"
      "<hardware>\n"
      "  <plugin>orient_gazebo_plugins/GazeboSimSystem</plugin>\n"
      "</hardware>\n"
      "<gazebo>\n"
      "  <plugin filename=\"orient_gazebo_plugins-system\""
      "name=\"orient_gazebo_plugins::GazeboSimROS2ControlPlugin\">\n"
      "    ...\n"
      "  </plugin>\n"
      "</gazebo>"
    );
...
PLUGINLIB_EXPORT_CLASS(
  orient_gazebo_plugins::GazeboSimSystem, orient_gazebo_plugins::GazeboSimSystemInterface)
