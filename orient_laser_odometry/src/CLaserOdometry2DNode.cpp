...
#include "orient_laser_odometry/CLaserOdometry2DNode.hpp"
...
CLaserOdometry2DNode::CLaserOdometry2DNode(): Node("CLaserOdometry2DNode")
{
  ...
  this->get_parameter("freq", freq);
    ...
    this->declare_parameter("pose_covariance_factor", 0.1);
  this->declare_parameter("orient_covariance_factor", 0.1);
  this->declare_parameter("twist_covariance_factor", 0.2);
  pose_covariance_factor_ = this->get_parameter("pose_covariance_factor").as_double();
  orient_covariance_factor_ = this->get_parameter("orient_covariance_factor").as_double();
  twist_covariance_factor_ = this->get_parameter("twist_covariance_factor").as_double();
...
void CLaserOdometry2DNode::publish()
{
  ...
  // Estimate covariance based on motion speed and configurable factors
  ...
  // // Fill pose covariance matrix (6x6): [x, y, z, roll, pitch, yaw]
  // std::array<double, 36> pose_covariance = {};
  // pose_covariance[0]  = pose_covariance_factor_ + linear_speed * speed_factor;  // X
  // pose_covariance[7]  = pose_covariance_factor_ + linear_speed * speed_factor;  // Y
  // pose_covariance[14] = 1e6;  // Z (ignored)
  // pose_covariance[21] = 1e6;  // Roll (ignored)
  // pose_covariance[28] = 1e6;  // Pitch (ignored)
  // pose_covariance[35] = orient_covariance_factor_ + angular_speed * speed_factor; // Yaw

  // // Fill twist covariance matrix (6x6): [vx, vy, vz, vroll, vpitch, vyaw]
  // std::array<double, 36> twist_covariance = {};
  // twist_covariance[0]  = twist_covariance_factor_ + linear_speed * speed_factor;  // vX
  // twist_covariance[7]  = twist_covariance_factor_ + linear_speed * speed_factor;  // vY
  // twist_covariance[14] = 1e6;  // vZ
  // twist_covariance[21] = 1e6;  // vRoll
  // twist_covariance[28] = 1e6;  // vPitch
  // twist_covariance[35] = twist_covariance_factor_ + angular_speed * speed_factor; // vYaw

  // odom.pose.covariance = pose_covariance;
  // odom.twist.covariance = twist_covariance;

  // // 基于运动速度和扫描质量估算协方差
  // const double linear_speed = sqrt(rf2o_ref.lin_speed * rf2o_ref.lin_speed +
  //                                 odom.twist.twist.linear.y * odom.twist.twist.linear.y);
  // const double angular_speed = fabs(odom.twist.twist.angular.z);
  ...
  // pose_covariance[0]  = pose_covariance_factor_ + linear_speed * speed_factor;  // X
  // pose_covariance[7]  = pose_covariance_factor_ + linear_speed * speed_factor;  // Y
  // pose_covariance[14] = 1e6;  // Z (忽略)
  // pose_covariance[21] = 1e6;  // Roll (忽略)
  // pose_covariance[28] = 1e6;  // Pitch (忽略)
  // pose_covariance[35] = orient_covariance_factor_ + angular_speed * speed_factor; // Yaw
